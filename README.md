...
1. Выполните скрипт. Для этого откройте терминал, напишите `python3 ` и перетащите файл скрипта в окно теминала (должен подставиться путь к файлу через пробел)
